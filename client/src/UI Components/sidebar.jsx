...
export default function sidebar() {
  ...
  return (
    ...
    Dashboard
        ...
        {role === 'admin' && (<Link to="/AnalysisTime" className="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700" style={{ textDecoration: 'none' }}>
