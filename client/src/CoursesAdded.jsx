...
export default function CoursesAdded() {
  ...
  const handleCourseClick = (course, timespend) => {
      ...
      <div className="grid grid-cols-4 gap-4 h-min p-6">
        {courses.length === 0 ? (
          ...
          courses.map((course) => (
            <div
              key={course.id}
              onClick={() => handleCourseClick(course, course.timespend)}
            ...
            >
              ...
              />
              <div className="bg-white-100 shadow-2xl rounded-full h-2.5 w-full max-w-md">
                <div 
              ...
              <div className="flex">
                <ul className="w-1/3 border-r border-gray-300 p-4 space-y-4 flex flex-col items-center">
                  {Object.keys(selectedCourse.modules).map((moduleKey) => (
                    <li key={moduleKey} className="flex items-center w-full justify-start mb-2">
                      <span
                      ...
                      >
                        ...
                        <span 
                          ...
                          onClick={(e) => { e.stopPropagation(); handleModuleCompletion(moduleKey); }}
                        >
                          click here to mark complete
                        </span>
                      </span>
                    </li>
                  ))}
                  ...
                  {selectedModule ? (
                    <div className="w-full">
                      <h3 className="text-lg font-semibold mb-2 text-center">
                        <FaVideo className="inline mr-2 text-primary-100" /> Video Player
                      </h3>
                      {loading && (
